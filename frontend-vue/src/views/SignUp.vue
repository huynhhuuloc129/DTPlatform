                        ...
                        <div class="card bg-dark text-white" style="border-radius: 1rem;">
                            <div class="card-body p-5 text-center">
                                ...
                                <div class="mb-md-5 mt-md-4 pb-5">
                                    ...
                                    <p class="text-white-50 mb-5">Please enter your username and password to create an
                                        account!</p>
                                    <form @submit="onRegister">
                                        ...
                                        <button class="btn btn-outline-light btn-lg px-5 input-login"
...
onMounted(() => {
    if (checkLogin()) router.push({ name: 'dashboard' })
})
</script>
