<template>
    <header id="headerBar" class="p-3 text-white w-100" style="background-color: #23a5ae;">
    <div >
      <div id="barContent" class="d-flex flex-wrap align-items-center justify-content-between justify-content-lg-start">
